...
//! - To index a field on a subdocument which is not modelled (EG, using `Document` as a value for a field), you will have to manually implement `Model` for your struct & then manually specify the indexes. See the section below on [manually implementing model](#manually-implementing-model) on your structs.
//!
//! ### Migrations
//! See the documentation on the [migration](../migration/index.html) module.
//!
//! ## Using Your Model
//! TODO: add some notes on basic usage, such as find, update, delete &c.
//!
//! ### sync
//! Synchronize your model's indexes with the database.
//!
...
//! are actually using the database.
//!
