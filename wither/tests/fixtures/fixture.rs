...
lazy_static! {
    static ref DB: Database = {
        ...
        let port = env::var("PORT")
            ...
            .parse::<u32>()
            .expect("Environment variable PORT must be an instance of `u32`.");
...
impl Fixture {
    ...
    pub fn with_empty_collections(self) -> Self {
        ...
        User::delete_many(DB.clone(), doc! {})
            .expect("Expected to successfully delete all records for test fixture.");
        UserModelBadMigrations::delete_many(DB.clone(), doc! {})
            .expect("Expected to successfully delete all records for test fixture.");
        DerivedModel::delete_many(DB.clone(), doc! {})
            .expect("Expected to successfully delete all records for test fixture.");
        ...
        let other_users_coll = DB
            .clone()
            .collection(UserModelBadMigrations::COLLECTION_NAME);
    ...
    pub fn with_dropped_database(self) -> Self {
        DB.clone()
            .drop_database()
            .expect("Expected to be able to drop database.");
        self
    }
    ...
    pub fn with_synced_models(self) -> Self {
        ...
        DerivedModel::sync(DB.clone())
            .expect("Expected to successfully sync `DerivedModel` model.");
        Derived2dModel::sync(DB.clone())
            .expect("Expected to successfully sync `Derived2dModel` model.");
        Derived2dsphereModel::sync(DB.clone())
            .expect("Expected to successfully sync `Derived2dsphereModel` model.");
        // TODO: enable this once https://github.com/mongodb-labs/mongo-rust-driver-prototype/issues/289 lands.
